...
namespace SmtpRelay.GUI
{
    public partial class MainForm : Form
    {
        ...
        void InitializeComponent()
        {
            ...
            host = new(){Left=inX,Top=y,Width=600}; Controls.Add(host);
            ...
            starttls.CheckedChanged += StarttlsChanged;   // swaps default port
            Controls.Add(starttls);

            /* credentials */
            y += h+gap;
            Controls.Add(L(lblX,y+8,"Username:"));
            user = new(){Left=inX,Top=y,Width=280}; Controls.Add(user);
            ...
            ips = new(){Left=inX,Top=y,Width=650}; Controls.Add(ips);
            ...
            /* Save / Close buttons shifted left */
            ...
            /* info under Close */
            Controls.Add(L(btnClose.Left,btnClose.Bottom+6,
                           "Service will\nremain running"));
            ...
            {
                Left=Width-260, Top=Height-130, Text="Project site", AutoSize=true
            };
            link.Links.Add(0,link.Text.Length,
                "https://github.com/mkitchingh/Smtp-Relay");
            link.LinkClicked += (_,e)=>System.Diagnostics.Process.Start(
                new System.Diagnostics.ProcessStartInfo(
                    e.Link.LinkData.ToString()){UseShellExecute=true});
            Controls.Add(link);
        }
